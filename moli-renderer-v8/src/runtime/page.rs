...
impl JsRuntime {
    ...
    pub async fn create_document_page_best_effort(
        &self,
        requested_url: Url,
        ...
        parser_blocking_stylesheet_inputs: Vec<
    ...
    /// Moves an already parsed document and its bootstrap inputs onto the
    /// renderer owner lane without creating execution contexts or running
    /// document scripts.
    #[allow(clippy::too_many_arguments)]
    pub async fn prepare_document_page_with_inspector_session_restores(
        &self,
        page_reservation: RendererPageReservationToken,
        requested_url: Url,
        navigation_initiator_url: Option<Url>,
        ...
        let mut request = self
            .inner
            .renderer_owner
            .build_create_document_page_request(
                requested_url,
                navigation_initiator_url,
                navigation_redirected,
                navigation_redirect_count,
        ...
        let reply = self
            .inner
            .renderer_owner
            .dispatch_command(RendererOwnerCommand::PrepareNativeDomDocument {
        ...
        match reply {
            ...
            _ => Err(anyhow!(
                "renderer owner returned non-prepare reply for prepared NativeDom document request"
            )),
        }
    }
