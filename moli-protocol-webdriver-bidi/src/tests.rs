use moli_protocol::devtools_runtime::{
    ...
    DevToolsNetworkInterceptId, DevToolsRealmId, DevToolsRemoteValue, DevToolsRequestId,
    DevToolsStackCallFrame, DevToolsStackTrace, DevToolsTargetId, DevToolsTargetInfo,
    DevToolsTargetKind, LogEntryEvent, NavigationFrameEvent, NavigationFrameEventKind,
    NavigationLifecycleEvent, NetworkAuthChallengeEvent, NetworkRequestEvent,
